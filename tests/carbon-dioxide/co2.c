...
int main (int argc, char **argv) {
  ...
  for (unsigned int i = 0; i < mean->N; i++) {
    matrix_set(mean->X, i, 0, matrix_get(mean->X, i, 0) + 1995.0);
    matrix_set(var->X,  i, 0, matrix_get(var->X,  i, 0) + 1995.0);
  }
